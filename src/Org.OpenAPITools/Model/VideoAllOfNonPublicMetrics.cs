...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class VideoAllOfNonPublicMetrics : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoAllOfNonPublicMetrics" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public VideoAllOfNonPublicMetrics(Option<int?> playback0Count = default, Option<int?> playback100Count = default, Option<int?> playback25Count = default, Option<int?> playback50Count = default, Option<int?> playback75Count = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="VideoAllOfNonPublicMetrics" />
    /// </summary>
    public class VideoAllOfNonPublicMetricsJsonConverter : JsonConverter<VideoAllOfNonPublicMetrics>
    {
        /// <summary>
        /// Deserializes json to <see cref="VideoAllOfNonPublicMetrics" />
        /// </summary>
        ...
        public override VideoAllOfNonPublicMetrics Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (playback0Count.IsSet && playback0Count.Value == null)
                throw new ArgumentNullException(nameof(playback0Count), "Property is not nullable for class VideoAllOfNonPublicMetrics.");

            if (playback100Count.IsSet && playback100Count.Value == null)
                throw new ArgumentNullException(nameof(playback100Count), "Property is not nullable for class VideoAllOfNonPublicMetrics.");

            if (playback25Count.IsSet && playback25Count.Value == null)
                throw new ArgumentNullException(nameof(playback25Count), "Property is not nullable for class VideoAllOfNonPublicMetrics.");

            if (playback50Count.IsSet && playback50Count.Value == null)
                throw new ArgumentNullException(nameof(playback50Count), "Property is not nullable for class VideoAllOfNonPublicMetrics.");

            if (playback75Count.IsSet && playback75Count.Value == null)
                throw new ArgumentNullException(nameof(playback75Count), "Property is not nullable for class VideoAllOfNonPublicMetrics.");

            return new VideoAllOfNonPublicMetrics(playback0Count, playback100Count, playback25Count, playback50Count, playback75Count);
        }

        /// <summary>
        /// Serializes a <see cref="VideoAllOfNonPublicMetrics" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="videoAllOfNonPublicMetrics"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, VideoAllOfNonPublicMetrics videoAllOfNonPublicMetrics, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, videoAllOfNonPublicMetrics, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="VideoAllOfNonPublicMetrics" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="videoAllOfNonPublicMetrics"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, VideoAllOfNonPublicMetrics videoAllOfNonPublicMetrics, JsonSerializerOptions jsonSerializerOptions)
        {
            if (videoAllOfNonPublicMetrics.Playback0CountOption.IsSet)
                writer.WriteNumber("playback_0_count", videoAllOfNonPublicMetrics.Playback0CountOption.Value!.Value);

            if (videoAllOfNonPublicMetrics.Playback100CountOption.IsSet)
                writer.WriteNumber("playback_100_count", videoAllOfNonPublicMetrics.Playback100CountOption.Value!.Value);

            if (videoAllOfNonPublicMetrics.Playback25CountOption.IsSet)
                writer.WriteNumber("playback_25_count", videoAllOfNonPublicMetrics.Playback25CountOption.Value!.Value);

            if (videoAllOfNonPublicMetrics.Playback50CountOption.IsSet)
                writer.WriteNumber("playback_50_count", videoAllOfNonPublicMetrics.Playback50CountOption.Value!.Value);

            if (videoAllOfNonPublicMetrics.Playback75CountOption.IsSet)
                writer.WriteNumber("playback_75_count", videoAllOfNonPublicMetrics.Playback75CountOption.Value!.Value);
        }
    }
}
